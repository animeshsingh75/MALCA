...
import com.project.malca.databinding.ActivityVideoCameraBinding
    ...
    companion object {
        ...
        fun getOutputDirectory(context: Context): File {
            ...
            val mediaDir = appContext.externalMediaDirs.firstOrNull()?.let {
                File(it, appContext.resources.getString(com.project.malca.R.string.app_name)).apply { mkdirs() }
            }
