...
import com.project.malca.databinding.ActivityOtpBinding
...
class OtpActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun setSpannableString() {
        val span = SpannableString(getString(com.project.malca.R.string.waiting_text, phoneNumber))
    ...
    private fun initView() {
        ...
        binding.verifyTv.text = getString(com.project.malca.R.string.verify_number, phoneNumber)
        setSpannableString()
